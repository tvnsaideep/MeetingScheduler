            ...
            MeetingModel.findOneAndRemove({ 'meetingId': req.params.meetingId }).exec((err, result) => {
                if (err) {
                    ...
                    let sendEmailOptions = {
                        ...
                        subject: `Your Meeting is Cancelled: ${newMeetingObj.meetingTopic}`,
                        html: `<h3> Meeting Canceled </h3>
                            <h1>
                              <br> Hi , ${newMeetingObj.participantName} .
                              <br> ${newMeetingObj.hostName} has cancelled the meeting: ${newMeetingObj.meetingTopic}.
                            </h1>
                            `
                    }
            ...
            MeetingModel.update({ 'meetingId': req.params.meetingId }, options).exec((err, result) => {
                if (err) {
                    ...
                    let sendEmailOptions = {
                        ...
                        html: `<h3> Your meeting has been Changed! </h3>
                              <br> Hi , ${newMeetingObj.participantName} .
                              <br> ${newMeetingObj.hostName} Updated the meeting: ${options.meetingTopic}.
                              <br>
                                      
                              <div class="card" style="width: 18rem;text-align:center;font-weight:bold;background-color:lightblue;">
                                  <div class="card-body">
                                      <h5 class="card-title">Agenda</h5>
                                      <p class="card-text" style="color:blue;">${options.meetingDescription}</p>
                                  </div>
                              </div>
                              ...
                              <div class="card" style="width: 18rem;text-align:center;font-weight:bold;background-color:lightblue;">
                                  <div class="card-body">
                                      ...
                                      <p class="card-text" style="color:blue;">${options.meetingStartDate}</p>
                                  </div>
                              </div>
                              ...
                              <div class="card" style="width: 18rem;text-align:center;font-weight:bold;background-color:lightblue;">
                                  <div class="card-body">
                                      ...
                                      <p class="card-text" style="color:blue;">${options.meetingPlace}</p>
                                  </div>
                              </div>
                ...
                if (err) {
                    ...
                    let sendEmailOptions = {
                        ...
                        html: `<h3> Your meeting is planned! </h3>
                              <br> Hi , ${newMeetingObj.hostName} has scheduled a meeting with you.
                              <br>  
                            ...
                            for(let meeting of meetingDetails){
                                if(time.isSameDayAsToday(meeting.meetingStartDate) ){
                                    ...
                                    let sendEmailOptions = {
                                        ...
                                        html: `<h1> Gentle Reminder !!</h1>
                                              <br>
                                              <p style="font-wieght:bold;"> Just a reminder about your upcoming meeting Today <br>
