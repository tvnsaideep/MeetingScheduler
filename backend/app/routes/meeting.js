...
module.exports.setRouter = (app) => {
    ...
    */
     ...
     * @apiGroup Meetings
     * @apiVersion  1.0.0
     * @api {put} /api/v1/meetings/:meetingId/updateMeeting Update Meeting.
     *
     * @apiParam {string} authToken Authentication Token. (body/header/query params) (required)
    ...
    */
     ...
     * @apiGroup Meetings
     * @apiVersion  1.0.0
     * @api {get} /api/v1/meetings/view/all/meetings/:userId Get All Meetings Of User.
     *
    ...
    */
     ...
     * @apiGroup Meetings
     * @apiVersion  1.0.0
     * @api {get} /api/v1/meetings/:meetingId/details Get Meeting Details.
     *
    ...
    */
     ...
     * @apiGroup Meetings
     * @apiVersion  1.0.0
     * @api {post} /api/v1/meetings/admin-meetings/sentReminders Send Reminders.
     *
